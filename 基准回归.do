...
label var collective_participation "集体参与"
...
* Col2 集体参与
oprobit collective_participation college_ratio age male rural_hukou only_child boarding ///
    parent_edu parent_age parent_health party_member ///
    family_econ_1 family_econ_2 family_econ_4 family_econ_5 ///
    i.school_grade, vce(cluster clsids)
est store m2
...
* 输出：基准回归
esttab m1 m2 m3 m4 using "Table3_Baseline_Clean.rtf", replace ///
    b(%6.3f) se(%6.3f) star(* 0.1 ** 0.05 *** 0.01) ///
    keep(college_ratio) ///
    mtitles("Peer" "Collective" "Discipline" "Prosocial") ///
    title("Table 3: Baseline Results (Clean Model)") ///
    addnotes("No class-level controls (Random Assignment Justified)" ///
             "Controls: Student & Family Characteristics" ///
             "School-Grade FE & Class-clustered SE") ///
    nocons nonumbers nogaps compress scalar(N)

display "======================================================"
display "基准回归已输出：Table3_Baseline_Clean.rtf"
