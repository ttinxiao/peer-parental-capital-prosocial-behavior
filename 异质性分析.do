...
*=====================================================================
* 5. 控制变量（全部使用 if !missing() 确保缺失值为系统缺失 .）
*=====================================================================
...
*=====================================================================
* 6. 异质性分组变量（使用 if !missing() 确保缺失值为系统缺失 .）
*=====================================================================
...
esttab het_gender het_hukou het_paredu het_income het_onlychild ///
    using "Table8_Heterogeneity.rtf", replace ///
    b(%6.3f) se(%6.3f) star(* 0.1 ** 0.05 *** 0.01) ///
    keep(*college_ratio*) scalars(N r2_a) ///
    mtitles("Gender" "Hukou" "ParentEdu" "Income" "OnlyChild") ///
    title("Table 8: Heterogeneity Analysis (School Belonging Updated)") ///
    addnotes("Dependent: Prosocial (C17 only, school belonging updated)" ///
