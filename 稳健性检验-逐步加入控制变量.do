...
* 9. 输出表格
*=====================================================================
esttab m1 m2 m3 m4 m5 m6 m7 using "Table6_Robustness_Stepwise_Final.rtf", replace ///
    b(%6.3f) se(%6.3f) star(* 0.1 ** 0.05 *** 0.01) ///
    keep(college_ratio) scalars(N r2_a) ///
    mtitles("FE" "+Student" "+Family" "+Class" "+Board" "+Social" "+Engage") ///
    title("Table 6: Robustness - Stepwise Controls (Final Version)") ///
    addnotes("Dependent: Prosocial Index (C17 only)" ///
             "Class-clustered SE; School-Grade FE in all models") ///
    nocons nonumbers compress nogaps

display ""
display "==================== 稳健性检验3完成 ===================="
display "✅ 表格已输出至: Table6_Robustness_Stepwise_Final.rtf"
display "================================================================"
